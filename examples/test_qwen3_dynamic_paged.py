...
from trimkv.cache_utils import PagedDynamicBudgetTrimKVCache
...
past_key_values = PagedDynamicBudgetTrimKVCache(page_size=256, num_layers=model.config.num_hidden_layers, device='cuda')
